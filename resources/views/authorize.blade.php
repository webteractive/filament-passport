...
<head>
    ...
    <title>{{ __('filament-passport::filament-passport.oauth.authorization_request') }}</title>
    <style>
...
<body>
    <div class="card">
        <h2 class="title">{{ __('filament-passport::filament-passport.oauth.authorization_request') }}</h2>
        <p class="description">
